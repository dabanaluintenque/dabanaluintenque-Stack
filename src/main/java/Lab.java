...
public class Lab {
    ...
    public Deque<String> createNewStack(){
        ...
        Deque<String> stackObject = new ArrayDeque<>();
    ...
    public String removeFromTopOfStack(Deque<String> stack){
        ...
        String removeTopValue = stack.removeLast();

        return removeTopValue;
    }
    /**
    ...
    public String getTopOfStackWithoutRemoving(Deque<String> stack){
        ...
        String peekStackValue = stack.peekLast();

        return peekStackValue;
    }
}
